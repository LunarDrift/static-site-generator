...
def split_nodes_delimiter(old_nodes, delimiter, text_type):
    ...
    Takes a list of 'old nodes', a delimter, and a text type. Returns a list of TextNodes split by the delimiter."""
    new_nodes = []
...
def text_to_textnodes(text):
    """Convert plain text to a list with a single TextNode of type TEXT."""
